        ...
        <div className="section-container">
          ...
          <div className="text-frame">
            <p>
              ...
              opened the door to the space age. Since then, we've sent thousands
              of satellites into orbit, but we haven't been great about cleaning
              up after ourselves.
            </p>
            <p>
              In 2010, NASA scientist{" "}
              <b className="highlight">Donald Kessler</b> warned of a dangerous
              chain reaction: as debris collides, it creates more debris,
              increasing the chance of even more collisions. This nightmare
              scenario known as the{" "}
              <b className="highlight">Kessler Syndrome</b> is no longer just a
              theory.
            </p>
          </div>
        ...
        <div className="section-container">
          ...
          <div className="text-frame">
            <p>
              ...
              creative and high-tech solutions are being developed to fight
              space debris.
            </p>
            <p>
              One method involves{" "}
              ...
              and these technologies have already started undergoing testing to
              intercept space junk in orbit.
            </p>
          </div>
          ...
          <div className="text-container">
            <div className="text-frame">
              ...
              <p>
                ...
                , including any damage it may cause. In 2017, the{" "}
              ...
              <div className="text-frame">
                <p>
                  Two years later, ESA funded the{" "}
                  <b className="highlight">ADRIOS mission</b>, led by
                  ClearSpace, to actively retrieve a piece of satellite
                  equipment left in space. And in 2023, space agencies around
                  the world agreed on new guidelines mandating that inactive{" "}
                  <b className="highlight">
                    satellites must be removed from orbit within five years
                  </b>
                  . These policies mark real progress but there's still a long
                  way to go in building a truly sustainable future in space.
                </p>
            </div>
          </div>
        </div>
